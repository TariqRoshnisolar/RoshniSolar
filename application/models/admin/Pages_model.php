...
class Pages_model extends CI_Model {
	...
	public function aliasCheck($where=array()){
		...
		if($return > 0){
			return array('status'=>2,'msg'=>'Page alias alredy exists');
		} else {
	...
	public function deleteData($data=array()){
		if($data['ids']){
			...
			return array('status'=>1,'msg'=>'Data delete successfully');
		} else {
			return array('status'=>2,'msg'=>'Something went wrong,Please try again');
		}
	}
