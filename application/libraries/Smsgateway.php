...
class Smsgateway {
        ...
        if (!empty($sms_detail)) {
            ...
            */
            ...
            if ($sms_detail->type == 'clickatell') {
                ...
                $response = $this->_CI->msgnineone->sendSMS($send_to, $msg);
    ...
    public function sendotp($contactno, $email){

        $sms_detail = $this->_CI->smsconfig_model->getActiveSMS();

        if( !empty($sms_detail) ){

             if($sms_detail->type == 'msg_nineone'){
                ...
                $response = $this->_CI->msgnineone->sendotp($contactno, $email);
    ...
    public function sendotptomobile($contactno){
        ...
        if( !empty($sms_detail) ){
             ...
             if($sms_detail->type == 'msg_nineone'){
                ...
                $response = $this->_CI->msgnineone->sendotptomobile($contactno);
    ...
    public function sendotptoemail($email){
        ...
        if( !empty($sms_detail) ){
             ...
             if($sms_detail->type == 'msg_nineone'){
                ...
                $response = $this->_CI->msgnineone->sendotptoemail($email);
    ...
    public function verifyotp($otp, $contactno){
        ...
        if( !empty($sms_detail) ){
             ...
             if($sms_detail->type == 'msg_nineone'){
                ...
                $response = $this->_CI->msgnineone->verifyotp($otp, $contactno);
    ...
    public function sendmailotp($email, $rndno){
        ...
        if( !empty($sms_detail) ){
             ...
             if($sms_detail->type == 'msg_nineone'){
                ...
                $response = $this->_CI->msgnineone->sendmailotp($email, $rndno);
