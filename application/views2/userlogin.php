...
<html lang="en">
    <head>
        ...
        <title>Trigent ERP : School Management System</title>
...
/*
body{
    background-image: url('http://localhost:82/smartschool/backend/usertemplate/assets/img/backgrounds/banner-school.png');
}
*/
.form-bottom{
...
if(empty($notice)){
    ...
    $offset="col-md-offset-3";
                         ...
                         ?>
        <!-- <div class="col-lg-4 col-sm-4 <?php echo $offset; ?> form-box"> -->
                        <div class="col-lg-4 col-sm-4 col-md-offset-4 form-box">
                            <div class="loginbg">
                                <div class="headerImg">
                            ...
                            <div class="form-bottom">
                                ...
                                <form action="<?php echo site_url('site/userlogin') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="username" placeholder="<?php echo $this->lang->line('username'); ?>" class="form-username form-control" id="email"> <span class="text-danger">
                                        </span></div>
