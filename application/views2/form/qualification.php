                    ...
                    <form id="qualificationfrm">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                <thead>
                                <tr class="bg-primary">
                                    <th scope="col" colspan="7">Education Qualification / शैक्षणिक योग्यता</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td>Degree/Subject/Stream ( डिग्री / विषय / स्ट्रीम )<span style="color: red">*</span></td>
                                    ...
                                    <td>Passed / बीतने के <span style="color: red">*</span></td>
                                    <td>Appeared / दिखाई दिया <span style="color: red">*</span></td>
                                </tr>
...
<!--                                 <tr>
                                ...
                                <tr>
                                    ...
                                    <th>Read / पढ़ें</th>
                                    <th>Write / लिखो </th>
                                    <th colspan="4">Speak / बोले</th>
                                </tr>

                                <tr>

                                    <th scope="col"><input type="text" class="form-control user_language" id="language_1" value="<?php
