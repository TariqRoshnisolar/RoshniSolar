                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th scope="col"><div class="form-group">
                                            ...
                                            <label for="exampleFormControlFile1">Upload Passport Size Photograph of the Candidate / उम्मीदवार के पासपोर्ट साइज फोटो अपलोड करें </label>

                                            <input type="file" class="form-control-file" id="photo">

                                            <small id="emailHelp" class="form-text text-muted">Photo should be 4.5cm X 3.5cm upto / 
                                             फोटो 4.5cm X 3.5cm तक होना चाहिए <span style="color: red">50kb</span></small> </div></th>

                                    <th scope="col"><img id="preview_photo" src="<?php 
                                ...
                                <tr>
                                    ...
                                    <th scope="col"><div class="form-group">
                                            ...
                                            <label for="exampleFormControlFile1">Upload Signature of the Candidate /  उम्मीदवार के हस्ताक्षर अपलोड करें</label>

                                            <input type="file" class="form-control-file" id="signature">

                                        </div>

                                        <small id="emailHelp" class="form-text text-muted">Signature should not be in CAPITAL / BLOCK letters upto / हस्ताक्षर कैपिटल / ब्लॉक अक्षरों में नहीं होना चाहिए <span style="color: red">50kb</span></small></th>

                                    <th scope="col"><img id="preview_signature" src="<?php 
...
function form_validation(){
    ...
    if($("#photo").prop('files')[0]){
        ...
        else if( allowed_extension.indexOf(photo_extension) == -1 ){
