...
<form method="post" action="<?php echo base_url(); ?>page/prsecy" id="form1">
    <div class="aspNetHidden">
        <input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
        <input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
        <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="8rn8LySKpgF7AyKvmhMvJ3bUYn0j9ZPR7rQ/xu6qqeXjr+4EMDBFcswUJVFB027BZW5ebscvmwz/ANyt1uF9VfHLfebriy1pCE2lwefiVF0=" />
    </div>
...
<div class="aspNetHidden">
    ...
    <input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="684384FA" />
            ...
            <table class="tbl" width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
              ...
              <tr>
                <th style="width: 100%; text-align:Center; border-width: 0px;">
                    <span id="ContentPlaceHolder1_Label7">Additional Chief Secretary</span>
                </th>
                ...
                <div style ="font-family:georgia;color:#505050; font-size :13px ;text-align: justify; font:verdana; padding :15px;">
                    ...
                    <div class="busi_content" style="padding-left:10px;font-size:13px;color:black">
                      <div align="justify">
                        ...
                        <strong>Dr. M.V.Rao, I.A.S.</strong><br />
                    </div>
                    ...
                    <div class="busi_content" style="padding-left:12px; margin-top:10px; margin-bottom:20px">
                      <div align="justify">
                          ...
                          <p>  Panchayat &amp; Rural Development Department</p>
                          <p> Government of West Bengal</p>
                          <p> LandLine No. : 033-2335-5501</p>
                      </div>
                  </div>
                  ...
                  <div class="busi_content" style="padding-left:12px; margin-top:10px; margin-bottom:20px">
                      <div align="justify">
                        <p>Joint Administrative Building,<br /></p>
                        <p>Block HC-7, Sector III, SaltLake<br /></p>
                        <p>Kolkata &#8211; 700106.</p>
                    </div></div>
