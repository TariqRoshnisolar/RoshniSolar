...
<div id='cssmenu'>
 <ul>
                        ...
                        <li class="<?php echo set_Topmenu('Dashboard'); ?>"><a href="<?php echo base_url(); ?>user/user/dashboard">Home<?php //echo $this->lang->line('my_profile'); ?></a></li>
                        <?php
                        if ($this->module_lib->hasActive('fees_collection')) {
                            ?>
                            <li class="<?php echo set_Topmenu('user/user/getfees'); ?>"><a href="<?php echo base_url(); ?>user/user/getfees"><?php echo $this->lang->line('fees'); ?></a></li>
                            <?php
                        }

if ($this->module_lib->hasActive('academics') || $this->module_lib->hasActive('communicate') || $this->module_lib->hasActive('homework') || $this->module_lib->hasActive('transport') || $this->module_lib->hasActive('hostel')) {
                            ?>
...
<li class="<?php echo set_Topmenu('Subjects'); ?>"><a href="<?php echo base_url(); ?>user/subject"> <?php echo $this->lang->line('subjects'); ?></a></li>

<li class="<?php echo set_Topmenu('Teachers'); ?>"><a href="<?php echo base_url(); ?>user/teacher"><?php echo $this->lang->line('teachers'); ?></a></li>

<li class="<?php echo set_Topmenu('Time_table'); ?>"><a href="<?php echo base_url(); ?>user/timetable"><?php echo $this->lang->line('class_timetable'); ?></a></li>

<?php

if ($this->module_lib->hasActive('communicate')) {
                            ?>
                            <li class="<?php echo set_Submenu('user/notification'); ?>">
...
if ($this->module_lib->hasActive('homework')) {
                            ?>
                            <li class="<?php echo set_Topmenu('Homework'); ?>"><a href="<?php echo base_url(); ?>user/homework"><?php echo $this->lang->line('homework'); ?></a></li>
                            <?php
                        }

if ($this->module_lib->hasActive('transport')) {
                            ?>
                            <li class="<?php echo set_Submenu('route/index'); ?>"><a href="<?php echo base_url(); ?>user/route"> <?php echo $this->lang->line('transport_routes'); ?></a></li>
                            <?php
                        }

if ($this->module_lib->hasActive('hostel')) {
                            ?>
                            <li class="<?php echo set_Submenu('hostelroom/index'); ?>"><a href="<?php echo base_url(); ?>user/hostelroom"><?php echo $this->lang->line('hostel_rooms'); ?></a></li>
...
if ($this->module_lib->hasActive('student_attendance')) {
                            ?>
                            <li class="<?php echo set_Topmenu('Attendence'); ?>"><a href="<?php echo base_url(); ?>user/attendence"><?php echo $this->lang->line('attendance'); ?></a></li>
                            <?php
                        }

if ($this->module_lib->hasActive('examination')) {
                            ?>
                            <li class="<?php echo set_Topmenu('Examinations'); ?>">
                                <a href="#">
                                    <span><?php echo $this->lang->line('examinations'); ?></span> 
                                </a>
                                <ul>
                                    <li class="<?php echo set_Submenu('mark/marklist'); ?>"><a href="<?php echo base_url(); ?>user/mark/marklist"> <?php echo $this->lang->line('report_card'); ?></a></li>
                                    <li class="<?php echo set_Submenu('examSchedule/index'); ?>"><a href="<?php echo base_url(); ?>user/examschedule"> <?php echo $this->lang->line('exam_schedule'); ?></a></li>
                                </ul>
                            </li>
                            <?php
                        }
...
if ($this->module_lib->hasActive('library')) {
                            ?>
                            <li class="<?php echo set_Topmenu('Library'); ?>">
                                <a href="#">
                        ...
                        if ($this->module_lib->hasActive('download_center')) {
                            ...
                            <li class="<?php echo set_Topmenu('Downloads'); ?>">
                                ...
                                <ul>
                                    <li class="<?php echo set_Submenu('content/assignment'); ?>"><a href="<?php echo base_url(); ?>user/content/assignment"><?php echo $this->lang->line('assignments'); ?></a></li>
                                    <li class="<?php echo set_Submenu('content/studymaterial'); ?>"><a href="<?php echo base_url(); ?>user/content/studymaterial"><?php echo $this->lang->line('study_material'); ?></a></li>
                                    <li class="<?php echo set_Submenu('content/syllabus'); ?>"><a href="<?php echo base_url(); ?>user/content/syllabus"><?php echo $this->lang->line('syllabus'); ?></a></li>
                                    <li class="<?php echo set_Submenu('content/other'); ?>"><a href="<?php echo base_url(); ?>user/content/other"><?php echo $this->lang->line('other_downloads'); ?></a></li>
                                </ul>
                            </li>
                            <?php
                        }
