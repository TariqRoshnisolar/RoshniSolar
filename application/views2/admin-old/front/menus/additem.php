<script src="<?php echo base_url('backend/themes/default/js/jquery.mjs.nestedSortable.js'); ?>"></script>
<style type="text/css">
    ol {
        margin: 0;
        padding: 0;
                                                                          ...
                                                                          if(!empty($submenu_value['submenus'])){
                                                                              ...
                                                                              foreach($submenu_value['submenus'] as $ckey=>$cval){
                                                                                  ?>
                                                                                      ...
                                                                                      <li id="list_<?php echo $cval['id']; ?>">
                                                                                          <div class="ui-sortable-handle">
                                                                        <?php echo $cval['menu']; ?>

                                                                        <span class="pull-right">
                                                                            <a href="<?php echo site_url('admin/front/menus/edititem/' . $cval['slug'] . "/" . $top_menu) ?>" class="btn btn-xs" title="Edit Item"><i class="fa fa-pencil"></i></a>  
                                                                            <a href="#" class="btn btn-xs" title="Delete Item" data-id="<?php echo $cval['id']; ?>" id="deleteItem" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-remove"></i></a>
                                                                        </span>
                                                                        </div></li>
