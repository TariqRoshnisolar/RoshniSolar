...
if(empty($notice)){
    ...
    $offset="col-md-offset-3";
                        ...
                        <img src="<?php echo base_url(); ?>backend/usertemplate/assets/img/backgrounds/logo.png" class="headerimg img-circle center-block img-thumbnail">
                        </div>

                        <div class="form-top">
                        <div>
                            <p class="name text-center">
                        UJJAL VIKAS SOLAR INDIA LIMITED
                            </p>
                        </div>
