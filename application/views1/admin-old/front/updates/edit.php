...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/front/updates/edit/' . $result['slug']) ?>" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-9">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Updates</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" id="from_date" name="from_date" readonly="readonly" value="<?php echo set_value('to_date', date('d-m-Y', strtotime($result['from_date'])) ); ?>" type="text"/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" id="to_date" name="to_date" readonly="readonly" value="<?php echo set_value('to_date', date('d-m-Y', strtotime($result['to_date'])) ); ?>" type="text"/>
                                <span class="text-danger"><?php echo form_error('to_date'); ?></span>
                            </div> 
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="exampleInputEmail1"><?php echo 'Page Link'; ?></label>
                                <input id="link" name="link" placeholder="" type="text" class="form-control"  value="<?php echo set_value('link', $result['link']); ?>" />
                            ...
                            <div class="form-group">
                                <div class="material-switch">
                                    <select name="update_type" class="form-control">
                                        ...
                                        <option value="1" <?php echo ($result['update_type']==1)?  'selected' : '' ?>>Notice Board</option>
                                        <option value="2" <?php echo ($result['update_type']==2)?  'selected' : '' ?>>Recruitment</option>
                                        <option value="3" <?php echo ($result['update_type']==3)? 'selected' : '' ?>>Our Partners</option>
                                        <option value="4" <?php echo ($result['update_type']==4)? 'selected' : '' ?>>Download</option>
                                    </select>
                                <span class="text-danger"><?php echo form_error('update_type'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>                                 
