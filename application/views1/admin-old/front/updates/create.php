...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form id="form1" action="<?php echo site_url('admin/front/updates/create') ?>" enctype="multipart/form-data" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="col-md-9">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" id="from_date" name="from_date" readonly="readonly" value="<?php echo set_value('from_date', date($this->customlib->getSchoolDateFormat())); ?>" type="text"/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control date" id="to_date" name="to_date" readonly="readonly" value="<?php echo set_value('to_date', date($this->customlib->getSchoolDateFormat())); ?>" type="text"/>
