      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          <div class="col-lg-5 video-box">
            <img src="<?php echo base_url();?>assets/front/img/about.jpg" class="img-fluid w-100" alt="" style="height: 93%;">
            <a href="https://www.youtube.com/watch?v=BzM_CBRNHTs" class="play-btn mb-4" data-fancybox></a>
          </div>
            ...
            <div class="tab" role="tabpanel">
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                  ...
                  ?>
                  <a href="https://roshnisolar.in/who-we-are" class=""><?php echo $this->lang->line('know_more'); ?></a> 
                </div>
