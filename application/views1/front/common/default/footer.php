      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-6 footer-info">
            ...
            <p>
              <?php 
                $home_description = json_decode(getPageDetailsByAlias('who_we_are','home_description'),true);
                echo (strlen($home_description[getSessionLang()])>150)?substr($home_description[getSessionLang()], 0,150):$home_description[getSessionLang()];
              ?>
              <br> 
  ...
  <div class="sticky-container">
    <ul class="sticky">
        ...
        <li>
            ...
            <p><a href="https://api.whatsapp.com/send?phone=+919732706072" target="_blank"><b>Whatsapp</b><br>9732706072</a></p>
        </li>
        <!-- <li>
