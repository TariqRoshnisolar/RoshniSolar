...
class Timetable extends Student_Controller {
    ...
    function index() {
        ...
        $classsectiondetail = $this->classsection_model->getDetailbyClassSection($class_id, $section_id);
            $classsectionid = $classsectiondetail['id'];
            $gettimetable = $this->timetable_model->gettimetable($classsectionid);
