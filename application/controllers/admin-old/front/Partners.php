...
class Partners extends Admin_Controller {
    ...
    function index() {
        ...
        $this->load->view('admin/front/partners/index', $data);
    ...
    function add() {
        ...
        // $this->session->set_userdata('top_menu', 'Front CMS');
        // $this->session->set_userdata('sub_menu', 'admin/front/banner');
        $partners_content = $this->config->item('ci_front_partners_content');
    ...
    function remove() {
        ...
        $partner_content = $this->config->item('ci_front_partners_content');
        $this->form_validation->set_rules('content_id', 'Fees Payment Id', 'required|trim|xss_clean');
        if ($this->form_validation->run() == false) {
            $data = array(
                'content_id' => form_error('content_id'),
