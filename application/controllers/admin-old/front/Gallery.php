...
class Gallery extends Admin_Controller {
    ...
    function create() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $silder_images = $this->input->post('silder_images');
            $gallery_array = array();
            if (isset($gallery_images)) {
                foreach ($gallery_images as $gallery_key => $gallery_value) {
                    ...
                    if(!empty($silder_images) &&  in_array($gallery_value, $silder_images) ){
                        $array['is_slider'] = 1;
                    }
                    else{
                        $array['is_slider'] = 0;
    ...
    function edit($slug) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            //         $array['program_id'] = 0;
            //         $array['media_gallery_id'] = $gallery_value;
            //         if( in_array($gallery_value, $silder_images) ){
            //             $array['is_slider'] = 1;
            //         }
            //         else{
            //             $array['is_slider'] = 0;
            ...
            $data['url'] = $this->config->item('ci_front_page_read_url') . $data['slug'];
            $this->cms_program_model->update_batch($data, $gallery_array);
