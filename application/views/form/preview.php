...
<div class="logodiv">
    <img class="logoforpreview" src="<?php echo base_url(); ?>assets/front/img/logo.png" style="width: 50%;"/>
</div>
...
<div class="info">
    ...
    <span class="middledot">:</span>
    <div class="rightinfo"><?php
        if(isset($data['jobstate']) && !empty($data['jobstate'])){
            $count = 1;
            foreach($data['jobstate'] as $applied_jobstate){
                echo $count.'. '.$applied_jobstate['state'];
                echo "<br />";
                $count++;
            }
        }?></div>
...
<?php if(isset($data['spouse_name']) && !empty($data['spouse_name'])){?>
<div class="info">
...
<br>
<h4 class="full-label">Present Address</h4>
<div class="info">
...
<br>
<h4 class="full-label">Permanent Address</h4>
<div class="info">
    <div class="leftinfo"><b>Address Line 1</b></div>
    <span class="middledot">:</span>
...
<div class="sidephoto">
    <div class="sidephoto-wrap">
        <img  src="<?php echo base_url().'uploads/user_documents/user_photos/'.$data['photo']; ?>">
    </div>
</div>
<?php
}
...
<table class="languagetbl w-100">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $data['degree_name2']; ?></td>
                <td><?php echo $data['university2']; ?></td>
                <td><?php echo $data['marks2']; ?></td>
                <td><?php echo ($data['result2']==1) ? 'Passed':'Appeared' ; ?></td>
            </tr>
            <tr>
                <td><?php echo $data['degree_name3']; ?></td>
                <td><?php echo $data['university3']; ?></td>
                <td><?php echo $data['marks3']; ?></td>
                <td><?php echo ($data['result3']==1) ? 'Passed':'Appeared' ; ?></td>
            </tr>
        </tbody>
    </table>
</div>
...
<br>
<div class="col-md-10 d-flex justify-content-end m-auto">
<button type="button" class="btn btn-dark" id="print_preview" onclick="PrintData()">Print Preview</button>
<div class="ml-auto">
<a href="<?php echo base_url(); ?>index.php/form/doc_upload"><button type="button" class="btn btn-danger">Back</button></a>
