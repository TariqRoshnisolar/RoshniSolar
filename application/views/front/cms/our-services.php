    ...
    <section class="inner-page aboutPage">
      <div class="container">
        <div class="section-title text-left">
          ...
          ?>
                 <!-- <p> <?php echo $this->lang->line('epc_sollution'); ?>   </p> <br/> 

                <p><?php echo $this->lang->line('Engineering'); ?>   </p> <br/>        
                 <p><?php echo $this->lang->line('Procurement'); ?> </p> <br/>              
                 <p><?php echo $this->lang->line('Constraction'); ?>  </p> <br/> 
                <p> <?php echo $this->lang->line('Sub EPC'); ?>         </p> <br/>      

                 <p><?php echo $this->lang->line('Installation And Commissioning'); ?> </p> <br/> -->              
        ...
        <div class="row">
          <div class="col-lg-3">
            ...
            <ul class="nav nav-tabs flex-column sideNavTab">
              <li class="nav-item">
               ...
               <li class="nav-item mt-2">
                <a class="nav-link <?php echo (($this->uri->segment(1) == '' || $this->uri->segment(1) == '' || $this->uri->segment(1) == '' || $this->uri->segment(1) == 'solar-parks' || $this->uri->segment(1) == 'floating-solar-system')?'show active':''); ?>" data-toggle="tab" href="#tab-4">
                  <div class="d-flex align-items-center">
                    <div class="icon"><img src="<?php echo base_url(); ?>assets/front/img/goal.png"></div>
                    <div class="ml-3">
                      <h6  class="m-0"><?php echo $this->lang->line('Solar PV System'); ?></h6>
                      <p class="m-0"><i class="fa fa-long-arrow-right"></i></p>
                    </div>
                  </div>
                </a>
               ...
               <li class="nav-item mt-2">
                <a class="nav-link <?php echo (($this->uri->segment(1) == '' || $this->uri->segment(1) == '' || $this->uri->segment(1) == '' || $this->uri->segment(1) == '' || $this->uri->segment(1) == '')?'show active':''); ?>" data-toggle="tab" href="#tab-5">
                  <div class="d-flex align-items-center">
                    <div class="icon"><img src="<?php echo base_url(); ?>assets/front/img/goal.png"></div>
                    <div class="ml-3">
                      <h6  class="m-0"><?php echo $this->lang->line('Gross Metering And Net Metering'); ?></h6>
                      <p class="m-0"><i class="fa fa-long-arrow-right"></i></p>
                    </div>
                  </div>
                </a>
               ...
               <li class="nav-item mt-2">
                <a class="nav-link <?php echo (($this->uri->segment(1) == '' || $this->uri->segment(1) == '' || $this->uri->segment(1) == '' || $this->uri->segment(1) == '' || $this->uri->segment(1) == '')?'show active':''); ?>" data-toggle="tab" href="#tab-6">
                  <div class="d-flex align-items-center">
                    <div class="icon"><img src="<?php echo base_url(); ?>assets/front/img/goal.png"></div>
                    <div class="ml-3">
                      <h6  class="m-0"><?php echo $this->lang->line('Solar Quality Assurance'); ?></h6>
                      <p class="m-0"><i class="fa fa-long-arrow-right"></i></p>
                    </div>
                  </div>
                </a>
          ...
          <div class="col-lg-9">
            <div class="tab-content">			  
                ...
                ?>
                <!-- <?php echo $this->lang->line('Roshani Advantages'); ?> -->
              </div>			  
                ...
                ?>        
                <!-- <?php echo $this->lang->line('Solar Technology Solution'); ?> -->
                ...
                <div class="tab" role="tabpanel">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link <?php echo (($this->uri->segment(1) == 'Canal_top_Solar')?'active':''); ?>" id="tab3-tab" data-toggle="tab" href="#tab9" role="tab" aria-controls="tab3" aria-selected="false"><?php echo $this->lang->line('Canal_top_Solar'); ?></a>
                    </li>
                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade <?php echo (($this->uri->segment(1) == 'rooftop-solar' || $this->uri->segment(1) == 'solar-technology_solutions')?'show active':''); ?>" id="tab1" role="tabpanel" aria-labelledby="home-tab">
                      ...
                      ?>
                <!-- <?php echo $this->lang->line('Rooftop Solar'); ?> -->
                    ...
                    <div class="tab-pane fade <?php echo (($this->uri->segment(1) == 'ground-mounted-solar')?'show active':''); ?>" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                      ...
                      ?>
                <!-- <?php echo $this->lang->line('Ground Mounted Solar'); ?> -->
                    ...
                    <div class="tab-pane fade <?php echo (($this->uri->segment(1) == 'solar-parks')?'show active':''); ?>" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                      ...
                      ?>
                <!-- <?php echo $this->lang->line('Solar Parks'); ?> -->
                      ...
                      <div class="tab-pane fade <?php echo (($this->uri->segment(1) == 'Canal_top_Solar')?'show active':''); ?>" id="tab9" role="tabpanel" aria-labelledby="tab3-tab">
                      <?php 
                          $Canal_top_Solar = json_decode(getPageDetailsByAlias('Canal_top_Solar','description'),true);
                          echo $Canal_top_Solar[getSessionLang()];
                      ?>
                <!-- <?php echo $this->lang->line('Solar Parks'); ?> -->
                    ...
                    <div class="tab-pane fade <?php echo (($this->uri->segment(1) == 'floating-solar-system')?'show active':''); ?>" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                      ...
                      ?>
                <!-- <?php echo $this->lang->line('Floating Solar System'); ?> -->
               ...
               <div class="tab-pane <?php echo (($this->uri->segment(1) == '')?'show active':''); ?>" id="tab-4">
                <h5> <?php echo $this->lang->line('Solar PV System'); ?></h5> 
                <?php 
                    $solar = json_decode(getPageDetailsByAlias('Solar PV System','description'),true);
                    echo $solar[getSessionLang()];
                ?>
                <!-- <?php echo $this->lang->line('Roshani Advantages'); ?> -->
              </div>  
               <div class="tab-pane <?php echo (($this->uri->segment(1) == '')?'show active':''); ?>" id="tab-5">
                <h5> <?php echo $this->lang->line('Gross Metering And Net Metering'); ?></h5> 
                <?php 
                    $gross_metering = json_decode(getPageDetailsByAlias('gross_metering','description'),true);
                    echo $gross_metering[getSessionLang()];
                ?>
                <!-- <?php echo $this->lang->line('Roshani Advantages'); ?> -->
              </div> 
              <div class="tab-pane <?php echo (($this->uri->segment(1) == '')?'show active':''); ?>" id="tab-6">
                <h5> <?php echo $this->lang->line('Solar Quality Assurance'); ?></h5> 
                <?php 
                    $Solar_Quality = json_decode(getPageDetailsByAlias('Solar_Quality','description'),true);
                    echo $Solar_Quality[getSessionLang()];
                ?>
                <!-- <?php echo $this->lang->line('Roshani Advantages'); ?> -->
              </div> 		  
                ...
                <h5><?php echo $this->lang->line('business_model'); ?></h5> 
                  ...
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                     ...
                     <li class="nav-item" role="presentation">
                      <a class="nav-link <?php echo (($this->uri->segment(1) == 'Open Access')?'active':''); ?>" id="tab6-tab" data-toggle="tab" href="#tab7" role="tab" aria-controls="tab7" aria-selected="false"><?php echo $this->lang->line('Open Access'); ?></a>
                    </li>                    
                  </ul>
                  <div class="tab-content" id="myTabContent">
                ...
                <!-- <?php echo $this->lang->line('Capex'); ?> -->
                    ...
                    <div class="tab-pane fade <?php echo (($this->uri->segment(1) == 'resco-opex-boat-considers-ppa')?'show active':''); ?>" id="tab6" role="tabpane6" aria-labelledby="tab6-tab">
                      ...
                      ?>
                <!-- <?php echo $this->lang->line('RESSCO/Opex/Boot'); ?> -->
                      
                    </div>
                     <div class="tab-pane fade <?php echo (($this->uri->segment(1) == 'resco-opex-boat-considers-ppa')?'show active':''); ?>" id="tab7" role="tabpane6" aria-labelledby="tab7-tab">
                      <?php 
                          $open_acces = json_decode(getPageDetailsByAlias('open_acces','description'),true);
                          echo $open_acces[getSessionLang()];
                      ?>
                <!-- <?php echo $this->lang->line('RESSCO/Opex/Boot'); ?> -->
