                ...
                <div class="row mb-3"> 
                  <ul class="product-list page-content">
                    <li class="highslide-gallery">
                        <a href="<?php echo base_url(); ?>assets/front/certification/new/img3.jpg" class="highslide" onclick="return hs.expand(this)" target="_blank">
                        <img src="<?php echo base_url(); ?>assets/front/certification/new/img3.jpg" class="img-responsive zoomImage" alt=""> 
                       </a>
                    </li>
                    <li class="highslide-gallery">
                       <a href="<?php echo base_url(); ?>assets/front/certification/new/img6.jpg" class="highslide" onclick="return hs.expand(this)" target="_blank">
                        <img src="<?php echo base_url(); ?>assets/front/certification/new/img6.jpg" class="img-responsive zoomImage" alt="">
                       </a>
                    </li>
                    <li class="highslide-gallery">
                       <a href="<?php echo base_url(); ?>assets/front/certification/new/img10.jpg" class="highslide" onclick="return hs.expand(this)" target="_blank">
                        <img src="<?php echo base_url(); ?>assets/front/certification/new/img10.jpg" class="img-responsive zoomImage" alt="">
                       </a>
                    </li>

                    <li class="highslide-gallery">
                       <a href="<?php echo base_url(); ?>assets/front/certification/new/img13.jpg" class="highslide" onclick="return hs.expand(this)" target="_blank">
                        <img src="<?php echo base_url(); ?>assets/front/certification/new/img13.jpg" class="img-responsive zoomImage" alt="">
                       </a>
                    </li>

                    <li class="highslide-gallery">
                       <a href="<?php echo base_url(); ?>assets/front/certification/new/img17.jpg" class="highslide" onclick="return hs.expand(this)" target="_blank">
                        <img src="<?php echo base_url(); ?>assets/front/certification/new/img17.jpg" class="img-responsive zoomImage" alt="">
                       </a>
                    </li>

                    <li class="highslide-gallery">
                       <a href="<?php echo base_url(); ?>assets/front/certification/new/img45.jpg" class="highslide" onclick="return hs.expand(this)" target="_blank">
                        <img src="<?php echo base_url(); ?>assets/front/certification/new/img45.jpg" class="img-responsive zoomImage" alt="">
                       </a>
                    </li>

                    <li class="highslide-gallery">
                       <a href="<?php echo base_url(); ?>assets/front/certification/new/Department of Labour-page-001.jpg" class="highslide" onclick="return hs.expand(this)" target="_blank">
                        <img src="<?php echo base_url(); ?>assets/front/certification/new/Department of Labour-page-001.jpg" class="img-responsive zoomImage" alt="">
                       </a>
                    </li>
                  </ul>
