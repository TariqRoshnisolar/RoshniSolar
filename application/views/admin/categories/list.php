				...
				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					<thead>
						<tr>
							...
							<th>
								<a href="javascript:void(0)" class="sorting category" onclick="sortBy('category','categories.category','ASC')">
									<span class="title">Name</span>
									<span class="sorting-icon">
										<i class="fas fa-sort-up commonSorting category_DESC"></i>
										<i class="fas fa-sort-down commonSorting category_ASC"></i>
									</span>
								</a>
							</th>
