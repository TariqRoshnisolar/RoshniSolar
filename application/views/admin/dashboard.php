    ...
    <a href="<?php echo base_url() ?>admin/subcategories">
      <div class="card border-left-secondary shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Total Sub Categories</div>
    ...
    <a href="<?php echo base_url() ?>admin/pages">
      <div class="card border-left-dark shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Total Pages</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">90</div>
            </div>
            <div class="col-auto">
              <i class="fa fa-fw fa-file fa-2x text-gray-300"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <a href="<?php echo base_url() ?>admin/faqs">
      <div class="card border-left-danger shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Total Faqs</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">152</div>
            </div>
            <div class="col-auto">
              <i class="far fa-fw fa-question fa-2x text-gray-300"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <a href="<?php echo base_url() ?>admin/emails">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Emails</div>
              <div class="h5 mb-0 font-weight-bold text-gray-800">4521</div>
            </div>
            <div class="col-auto">
