...
<div class="main_header">
  <div class="container">
    <div class="logo"><a href="index.html"><img src="<?php echo $base_assets_url; ?>images/logo.png" class="img-fluid" alt="uvsil logo"></a></div>
    <div class="top_right">
  ...
  <div class="container">
    <nav class="navbar navbar-expand-md navbar-light btco-hover-menu"> 
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          <li class="nav-item"> <a class="nav-link" href="index.html">Homes <span class="sr-only">(current)</span></a> </li>
...
<div class="ccr_inner_section">
  <div class="container">
    ...
    <div class="row mt-4 pt-2">
      <div class="col-md-8">
        <div class="inner_content"> <img src="images/about_us.jpg" class="img-fluid mb-3">
      ...
      <div class="col-md-4">
        <div class="ryt_side">
          <div class="list-group"> <a href="#" class="list-group-item list-group-item-action active"> Cras justo odio </a> <a href="#" class="list-group-item list-group-item-action">Dapibus ac facilisis in</a> <a href="#" class="list-group-item list-group-item-action">Morbi leo risus</a> <a href="#" class="list-group-item list-group-item-action">Porta ac consectetur ac</a> <a href="#" class="list-group-item list-group-item-action">Vestibulum at eros</a> <a href="#" class="list-group-item list-group-item-action">Dapibus ac facilisis in</a> <a href="#" class="list-group-item list-group-item-action">Morbi leo risus</a> <a href="#" class="list-group-item list-group-item-action">Porta ac consectetur ac</a> <a href="#" class="list-group-item list-group-item-action">Vestibulum at eros</a> </div>
        </div>
      </div>
    </div>
  </div>
