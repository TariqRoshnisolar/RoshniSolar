                                ...
                                <div class="table-responsive around10 pt0">
                                    <table class="table table-hover table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td  class="col-md-4">Aadhaar Number</td>
...
if( isset($student_fee_detail) ){
  ...
  // echo "</pre>";
   //exit;
    ...
    <div class="tshadow mb25 bozero"> 
    <h3 class="pagetitleh2">Paid Fee </h3>
    <div class="table-responsive around10 pt0">
        <table class="table table-hover table-striped tmb0" id="feetable">
            <thead>
                <tr>
                    <th>Installment</th>
                    <th>Paymode</th>
            ...
            <tbody>
                <?php
                   if( isset($student_fee_detail) ){
                   foreach( $student_fee_detail as $paid_fee){
                       ?>
                    <tr>
                       <td><?php echo $paid_fee['feeinstallmentname']; ?></td>
                       <td><?php echo $paid_fee['paymodename']; ?></td>
                       <td><?php echo 'Paid'; ?></td>
                       <td><?php echo $paid_fee['totalamt']; ?></td>
                       <td><button type="button" onclick="downloadreceipt(<?php echo $student['id'] ?>, <?php echo $paid_fee['id'] ?>)">Download</button></td>
                    </tr>
...
if( isset($student_pending_fee_detail) ){
     ?>
       
       <div class="tshadow mb25 bozero"> 
       <h3 class="pagetitleh2">Pending Fee </h3>
    <div class="table-responsive around10 pt0">
        <table class="table table-hover table-striped tmb0" id="feetable">
            <thead>
                <tr>
            ...
            <tbody>
                <?php
                   if( isset($student_pending_fee_detail) ){
                    foreach( $student_pending_fee_detail as $pending_fee){
                        ?>
                       <tr>
                       <td><?php echo $pending_fee['name']; ?></td>
                       <td><?php echo $pending_fee['dueondate']; ?></td>
                       <td><?php echo $pending_fee['duedate']; ?></td>
...
<div id="stufeereceipt" class="modal fade" role="dialog" style="overflow: auto !important;">
  <div class="modal-dialog" style="width: 963px !important;">

    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Fee Receipt
<button type="button" class="text-center btn btn-default" id="btnPrint"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>
        </h4>
      </div>
      <div class="modal-body" id="stufeereceiptbody">
...
<script type="text/javascript">
    ...
    printElement(document.getElementById("stufeereceiptbody"));
...
function printElement(elem, append, delimiter) {
    ...
    function downloadreceipt(studentid, receiptid){
        $.ajax({
            url:'<?php echo base_url('user/fee/stufeedetail'); ?>',
            method:'post',
            cache:false,
            data:{receiptid:receiptid, studentid:studentid},
            success:function(s){
                console.log(s);
                try{
                     $("#stufeereceiptbody").empty();
                   $("#stufeereceiptbody").append(s);
                     $("#stufeereceipt").modal('show');

//var path = 'http://localhost:82/smartschool/'+s;
