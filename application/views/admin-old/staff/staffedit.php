...
?>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                    <label for="exampleInputEmail1">Wings</label>
                                    <select name="wing" id="wing" class="form-control">
                                        ...
                                        <?php
                                            if(isset($winglist)){
                                               ...
                                               ?>
                                        <option value="<?php echo $wing['id']; ?>" <?php if( (isset($staff)) && ($staff['wing']==$wing['id']) ){echo set_select('wing', $wing['id'], true);} ?>><?php echo $wing['wing']; ?></option>
                                               <?php
                                            }
                                            }
                                        ?>
