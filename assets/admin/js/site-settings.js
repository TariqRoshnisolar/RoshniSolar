  ...
  $(".saveButton").click(function(){
    ...
    $( ".validate" ).each(function( index,element ) {  
      if(($(element).attr('name') == 'contact_email' || $(element).attr('name') == 'career_email' || $(element).attr('name') == 'business_email') && jQuery.trim($(element).val()) != '' && IsEmail($(element).val())==false){
       ...
       if(($(element).attr('name') == 'facebook_link' || $(element).attr('name') == 'twitter_link' || $(element).attr('name') == 'youtube_link' || $(element).attr('name') == 'instagram_link' || $(element).attr('name') == 'google_link' || $(element).attr('name') == 'linkedin_link') && jQuery.trim($(element).val()) != '' && IsUrl($(element).val())==false){
